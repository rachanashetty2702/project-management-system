...
public class Projectdetails extends JFrame {
	...
	public boolean addProject() {
		...
		try {
			start_date = dateFormat.parse(txt_startdate.getText());
			end_date = dateFormat.parse(txt_enddate.getText());
	...
	public Projectdetails() {
		...
		panel_3_3.setBorder(new MatteBorder(0, 10, 0, 0, (Color) new Color(85, 150, 206)));
		panel_3_3.setLayout(null);
		panel_3_3.setBackground(new Color(32, 75, 113));
		...
		txt_projectid.setBounds(444, 183, 541, 49);
		...
		lblEnterProjectId.setBounds(177, 162, 215, 90);
		...
		txt_projectname.setBounds(444, 275, 541, 49);
		...
		pname.setBounds(177, 251, 235, 90);
		panel_4.add(pname);
		
		//JCTextField txt_startdate = new JCTextField();
		txt_startdate.setSelectionColor(Color.WHITE);
		txt_startdate.setSelectedTextColor(Color.WHITE);
		txt_startdate.setPlaceholder("Enter Start Date ");
		txt_startdate.setPhColor(Color.BLACK);
		txt_startdate.setForeground(new Color(0, 0, 0));
		txt_startdate.setFont(new Font("Tahoma", Font.PLAIN, 22));
		txt_startdate.setBorder(new MatteBorder(0, 0, 5, 0, (Color) new Color(32, 75, 113)));
		txt_startdate.setBackground(Color.WHITE);
		txt_startdate.setBounds(444, 366, 541, 49);
		panel_4.add(txt_startdate);
		...
		lblEnterStartDate.setBounds(177, 342, 215, 90);
		panel_4.add(lblEnterStartDate);
		
		//JCTextField txt_enddate = new JCTextField();
		txt_enddate.setSelectionColor(Color.WHITE);
		txt_enddate.setSelectedTextColor(Color.WHITE);
		txt_enddate.setPlaceholder("Enter End Date ");
		txt_enddate.setPhColor(Color.BLACK);
		txt_enddate.setForeground(new Color(0, 0, 0));
		txt_enddate.setFont(new Font("Tahoma", Font.PLAIN, 22));
		txt_enddate.setBorder(new MatteBorder(0, 0, 5, 0, (Color) new Color(32, 75, 113)));
		txt_enddate.setBackground(Color.WHITE);
		txt_enddate.setBounds(444, 458, 541, 49);
		panel_4.add(txt_enddate);
		...
		lblEnterEndDate.setBounds(177, 434, 215, 90);
		...
		button_add.setBounds(459, 563, 430, 62);
