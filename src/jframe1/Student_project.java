...
public class Student_project extends JFrame {
	...
	public boolean adddetails() {
		...
		try {
			...
			String sql = "insert into project_ms.works_on values(?,?)";
	...
	public Student_project() {
		...
		panel_3_3_1.setBorder(new MatteBorder(0, 10, 0, 0, (Color) new Color(85, 150, 206)));
		panel_3_3_1.setLayout(null);
		panel_3_3_1.setBackground(new Color(32, 75, 113));
		...
		panel_3_4_2.setBounds(0, 314, 340, 78);
		...
		panel_3.setBounds(274, 10, 679, 100);
		panel_4.add(panel_3);
		
		JLabel lblNewLabel_1_1 = new JLabel("Student working on Project");
		lblNewLabel_1_1.setBounds(102, 0, 508, 93);
		panel_3.add(lblNewLabel_1_1);
		lblNewLabel_1_1.setIcon(new ImageIcon("C:\\Users\\rachana\\eclipse-workspace\\Project_Management_System\\icons1\\profile.png"));
		...
		txt_usn.setPhColor(new Color(0, 0, 0));
		txt_usn.setForeground(new Color(0, 0, 0));
		txt_usn.setFont(new Font("Tahoma", Font.PLAIN, 22));
		txt_usn.setBorder(new MatteBorder(0, 0, 5, 0, (Color) new Color(32, 75, 113)));
		txt_usn.setBackground(new Color(255, 255, 255));
		txt_usn.setBounds(467, 200, 541, 49);
		panel_4.add(txt_usn);
		...
		lblEnterProjectId.setBounds(177, 178, 215, 90);
		...
		txt_projectid.setPhColor(Color.BLACK);
		...
		txt_projectid.setBounds(467, 303, 541, 49);
		panel_4.add(txt_projectid);
		
		JLabel pname = new JLabel("Enter Project ID :");
		pname.setForeground(new Color(85, 150, 206));
		pname.setFont(new Font("Tahoma", Font.BOLD, 22));
		pname.setBounds(177, 278, 235, 90);
		panel_4.add(pname);
		...
		button_add.setBounds(368, 458, 430, 62);
